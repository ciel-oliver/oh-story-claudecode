...
# metadata.openclaw 在 15 个 skill 上全都有，拿它判定会把 reasonix / generic 项目误认成 OpenClaw。
...
assert_grep '全局分析/三维节奏\.md' "$SKILL_DIR/references/templates/agents/story-explorer.md" "story-explorer must require the current three-axis rhythm artifact"
